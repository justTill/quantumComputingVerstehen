...
\title[Ein Kurztitel]{Quanten Computing verstehen: Grovers Algorithmus}
%%%\subtitle{Untertitel / Subtitle} % falls benötigt
\author[Sabrina Cielas \and Till Pilarczyk]
{Sabrina Cielas\footnote{Hochschule Düsseldorf, Gebäude 4, Münsterstraße 156, 40476 Düsseldorf, Deutschland \email{sabrina.cielas@study.hs-duesseldorf.de}} \and
 Till Pilarczyk\footnote{Hochschule Düsseldorf, Gebäude 4, Münsterstraße 156, 40476 Düsseldorf, Deutschland \email{till.pilarczyk@study.hs-duesseldorf.de}}}
...
\section{Begriffserklärung (nur wenn Platz ist)}
...
\begin{itemize}
	...
	\item Messen
	\item Quantenorakel
	\item Hadamar Gatter bzw Pauli-Gatter 
	\item Lokalitätsprinzip
\end{itemize}
Falls wird noch Platz haben können wir diese begriffe noch erklären
\\ Habe eine Mail an den Schmidt geschrieben und gefragt, ob wir diese Sachen voraussetzten können
...
\section{Grovers-Algorithmus}
\input{groversAlgorithmen}

\section{Bestimmung der Anzahl an Grover-Iterationen}
\input{geometrischeVeranschaulichung}
\label{sec:geoVer}

\section{Varianten der Quantensuche}
\input{variantenDerQuantensuche}

\section{Anwendungen des Grovers Algorithmus}
\input{anwendungenDesGroversAlgorithmus}

\section{Folgen für die Fähigkeit von Quantencomputern }
\input{folgenFuerQuantencomputern}
